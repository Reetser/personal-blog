  ...
  <div class="container">
    ...
    <div class="form-container-inner">
      ...
      <p class="newsletter-description">
        ...
        This newsletter is <strong>100% privacy-by-default</strong> — no tracking, no third parties, no storage until
        you choose to send your email.
        💡 Tip: For maximum privacy, you can use an alias or disposable address that forwards to your inbox (e.g.
        <em>contact.language224@passinbox.com</em>).
      </p>

      <form id="newsletter-form" class="form" autocomplete="off" novalidate>
        <input id="email-input" class="form-input" type="email" placeholder="Enter your email address or alias"
          required />
